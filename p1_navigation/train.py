...
def dqn(agent: Agent, env, brain_name, n_episodes=2000, max_t=1000, eps_start=1.0, eps_end=0.01, eps_decay=0.995):
    """Deep Q-Learning.
...
def main():
    ...
    agent = Agent(state_size, action_size, SEED, device, DDQN, DUELING, DISTRIBUTIONAL)
